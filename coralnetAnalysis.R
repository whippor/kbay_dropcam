...
# drop site
adonis2(kelpValues ~ drop, data = coralnetwide, method = 'altGower', na.rm = TRUE)
# area
adonis2(kelpValues ~ area, data = coralnetwide, method = 'altGower', na.rm = TRUE)
...
ggplot(uscores1) + 
  scale_fill_viridis(discrete = TRUE, option = "G", begin = 0.3, end = 0.8, guide = guide_legend(title = "Year")) +
